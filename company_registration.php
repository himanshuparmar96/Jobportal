			        ...
			        <div class="form-group">
			        	...
			        	<div class="form-group">
			        		<div class="col-md-6">
			        			...
			        			<input type="number" name="c_number" minlength="10" maxlength="10" required class="form-control">
			        		</div>
			        	...
			        	<div class="form-group">
			        		...
			        		<textarea class="form-control" style="margin-left: 13px;float: center;width: 650px;"></textarea>	
			        		</div>
